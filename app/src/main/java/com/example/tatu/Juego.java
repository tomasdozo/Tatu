...
public class Juego extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout gInstrucciones;
    private LinearLayout gBotones;
    private HorizontalScrollView horizontalScroll;
    private List<Instrucciones> instrucciones;
    ...
    private void  graficar(){
        ...
        //Mostrar Mensaje
        switch (msg){
            case META: tvInfo.setText(R.string.cartel_meta);
                break;
            case PARADA: tvInfo.setText(R.string.cartel_parada);
                break;
            case PARADA_VISITADA: tvInfo.setText(R.string.cartel_parada_visitada);
                break;
            case FALTA_PARADA:tvInfo.setText(R.string.cartel_paradas_faltantes);
                break;
            case ERROR: tvInfo.setText(R.string.cartel_error);
                break;
            case NEUTRO: tvInfo.setText("");
            break;
            case NO_LLEGASTE: tvInfo.setText(R.string.cartel_no_llego);
            break;
        }
    ...
    private void recorrer(){
                ...
                //Click que no hace nada para evitar que vaya a los hijos
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ibLeft:
                instrucciones.add(Izquierda);
                aux.setImageResource(R.drawable.left);
                break;
            case R.id.ibForward:
                instrucciones.add(Avanzar);
